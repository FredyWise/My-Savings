...
import com.fredy.currency.data.countryModels.countryDTO.Currencies
import com.fredy.currency.data.countryModels.countryDTO.CurrencyHelper
...
import com.fredy.currency.data.countryModels.countryDTO.UsableCurrencyInfoItem
...
fun FirebaseRatesCache.toRatesCache(): RatesCache {
    return RatesCache(
        ...
        base = base,
        date = date,
        rates = CurrencyRatesDoubleConverter.toRates(rates)?: emptyList(),
        success = success,
        timestamp = timestamp,
        cachedTime = cachedTime
    )
