...
import com.fredy.ui.util.defaultLightExpenseColor
import com.fredy.ui.util.defaultLightIncomeColor
import com.fredy.ui.util.defaultLightTransferColor
...
class PreferencesRepositoryImpl @Inject constructor(
    ...
    override fun getIncomeColor(displayMode: DisplayMode): Flow<Color> =
        preferences.getPreference(INCOME_COLOR)
            .map { colorCode ->
                Color(
                    colorCode ?: when (displayMode) {
    ...
    override fun getExpenseColor(displayMode: DisplayMode): Flow<Color> =
        preferences.getPreference(EXPENSE_COLOR)
            .map { colorCode ->
                Color(
                    colorCode ?: when (displayMode) {
    ...
    override fun getTransferColor(displayMode: DisplayMode): Flow<Color> =
        preferences.getPreference(TRANSFER_COLOR)
            .map { colorCode ->
                Color(
                    colorCode ?: when (displayMode) {
