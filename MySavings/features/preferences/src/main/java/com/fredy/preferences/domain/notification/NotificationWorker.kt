package com.fredy.preferences.domain.notification
...
import com.fredy.theme.util.SavingsIcons.appIcon
...
class NotificationWorker(
    ...
    private fun buildAndShowDailyNotification() {
        ...
        val notificationIntent = Intent(context, activityProvider.getActivity()::class.java)
        val pendingIntent =
