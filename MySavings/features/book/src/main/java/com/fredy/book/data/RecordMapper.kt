...
fun Category.toDomainCategory(): com.fredy.domain.model.Category {
    return com.fredy.domain.model.Category(
        categoryId,
        userIdFk,
        categoryName,
        categoryType,
...
fun Wallet.toDomainWallet(): com.fredy.domain.model.Wallet {
    return com.fredy.domain.model.Wallet(
        walletId,
        userIdFk,
        walletName,
        walletAmount,
