package com.fredy.authentication.ui
...
import com.fredy.authentication.util.isValidLogin
import com.fredy.authentication.util.isValidPhoneNumber
import com.fredy.authentication.viewModel.AuthEvent
import com.fredy.authentication.viewModel.AuthState
...
fun SignIn(
    ...
    val launcher = rememberLauncherForActivityResult(
        ...
        val account = getSignedInAccountFromIntent(
            it.data
        )
        try {
