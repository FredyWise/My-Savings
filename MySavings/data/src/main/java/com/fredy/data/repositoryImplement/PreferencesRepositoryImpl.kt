...
class PreferencesRepositoryImpl @Inject constructor(private val context: Context) :
    ...
    override fun getDailyNotification(): Flow<Boolean> = preferences.getPreference(
...
//    }
    ...
    override fun getDailyNotificationTime(): Flow<LocalTime> = preferences.getPreference(
